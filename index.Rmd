...
=======
My interest in open source solution is twofold, first it enables development through joint effort and second it promotes equitable access and implementation of state-of-the art methods. I am conscious, however, that it also might comes at the cost of a steeper learning curve which can be intimidating for some. On the other hand, I would argue that the comprehensive documentation and dynamic communities supporting the solution presented here make the sailing through much smoother than it might appear. On top of the wide accessibility through open source/access the solutions presented here are available for most operating systems, including Mac, Windows and Linux, and should be portable across the different platforms.
>>>>>>> 8f9877590550a087022d0af60f7e831cd3159dfa
